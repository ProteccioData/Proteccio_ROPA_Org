...
//   const { addToast } = useToast();
  ...
  const validateStage = (stage) => {
    ...
    switch (stage) {
      case 1:
        if (!formData.purposeScope.naturePurpose) newErrors["purposeScope.naturePurpose"] = "This field is required";
        if (!formData.purposeScope.intendedOutcome) newErrors["purposeScope.intendedOutcome"] = "This field is required";
        if (!formData.purposeScope.productsServices) newErrors["purposeScope.productsServices"] = "This field is required";
        if (!formData.purposeScope.dataSubjects) newErrors["purposeScope.dataSubjects"] = "This field is required";
        if (!formData.purposeScope.personalData) newErrors["purposeScope.personalData"] = "This field is required";
        if (!formData.purposeScope.sensitiveDataInvolved) newErrors["purposeScope.sensitiveDataInvolved"] = "This field is required";
        break;
        
      case 2:
        if (!formData.necessityProportionality.processingNecessary) newErrors["necessityProportionality.processingNecessary"] = "This field is required";
        if (!formData.necessityProportionality.legalBasis) newErrors["necessityProportionality.legalBasis"] = "This field is required";
        if (!formData.necessityProportionality.dataMinimization) newErrors["necessityProportionality.dataMinimization"] = "This field is required";
        if (!formData.necessityProportionality.retentionPeriods) newErrors["necessityProportionality.retentionPeriods"] = "This field is required";
        if (!formData.necessityProportionality.accessControls) newErrors["necessityProportionality.accessControls"] = "This field is required";
        if (!formData.necessityProportionality.individualsInformed) newErrors["necessityProportionality.individualsInformed"] = "This field is required";
        break;
        
      case 3:
        if (!formData.riskIdentification.potentialRisks) newErrors["riskIdentification.potentialRisks"] = "This field is required";
        if (!formData.riskIdentification.riskLikelihood) newErrors["riskIdentification.riskLikelihood"] = "This field is required";
        if (!formData.riskIdentification.riskImpact) newErrors["riskIdentification.riskImpact"] = "This field is required";
        if (!formData.riskIdentification.vulnerableGroups) newErrors["riskIdentification.vulnerableGroups"] = "This field is required";
        break;
        
      case 4:
        if (!formData.riskMitigation.existingControls) newErrors["riskMitigation.existingControls"] = "This field is required";
        if (!formData.riskMitigation.additionalMeasures) newErrors["riskMitigation.additionalMeasures"] = "This field is required";
        if (!formData.riskMitigation.responsiblePersons) newErrors["riskMitigation.responsiblePersons"] = "This field is required";
        if (!formData.riskMitigation.residualRisk) newErrors["riskMitigation.residualRisk"] = "This field is required";
        break;
        
      case 5:
        if (!formData.signoffReview.dpoConsulted) newErrors["signoffReview.dpoConsulted"] = "This field is required";
        if (!formData.signoffReview.stakeholdersConsulted) newErrors["signoffReview.stakeholdersConsulted"] = "This field is required";
        if (!formData.signoffReview.feedbackObjections) newErrors["signoffReview.feedbackObjections"] = "This field is required";
        if (!formData.signoffReview.finalOutcome || formData.signoffReview.finalOutcome.length === 0) newErrors["signoffReview.finalOutcome"] = "This field is required";
        if (!formData.signoffReview.nextReviewDate) newErrors["signoffReview.nextReviewDate"] = "This field is required";
        if (!formData.signoffReview.accountablePerson) newErrors["signoffReview.accountablePerson"] = "This field is required";
        break;
    }
  ...
  const handleLinkAndComplete = async () => {
    ...
    //   addToast("success", "DPIA assessment completed and linked!");
      ...
      onClose();
      if (onDPIACreated) {
        onDPIACreated({ ...formData, status: "completed" });
      }
    } catch (error) {
  ...
  const renderStage1 = () => (
    <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
      <div className="bg-gray-50 dark:bg-gray-900 border border-[#828282] p-6 rounded-lg">
        <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Purpose & Scope</h3>
        <div className="space-y-6">
          {renderTextarea("purposeScope", "naturePurpose", {
            value: formData.purposeScope.naturePurpose,
            onChange: (e) => handleInputChange("purposeScope", "naturePurpose", e.target.value),
            placeholder: "Describe the nature and purpose of the processing...",
          ...
          {renderTextarea("purposeScope", "intendedOutcome", {
            ...
            onChange: (e) => handleInputChange("purposeScope", "intendedOutcome", e.target.value),
          ...
          {renderTextarea("purposeScope", "productsServices", {
            ...
            onChange: (e) => handleInputChange("purposeScope", "productsServices", e.target.value),
            placeholder: "List the products, services, systems, or processes involved...",
            label: "What products, services, systems, or processes are involved?",
            rows: 3,
          })}
          
          {renderTextarea("purposeScope", "dataSubjects", {
            value: formData.purposeScope.dataSubjects,
            onChange: (e) => handleInputChange("purposeScope", "dataSubjects", e.target.value),
          ...
          {renderTextarea("purposeScope", "personalData", {
            ...
            onChange: (e) => handleInputChange("purposeScope", "personalData", e.target.value),
            placeholder: "List categories of personal data being processed...",
            label: "What personal data is being processed? (Include categories)",
            rows: 3,
          })}
          
          {renderSelect("purposeScope", "sensitiveDataInvolved", {
            value: formData.purposeScope.sensitiveDataInvolved,
            onChange: (e) => handleInputChange("purposeScope", "sensitiveDataInvolved", e.target.value),
          ...
          {renderFileUpload("purposeScope", "supportingDocuments", "Please upload any supporting documents")}
        </div>
      </div>
    </div>
  );
  ...
  const renderStage2 = () => (
    <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
      <div className="bg-gray-50 dark:bg-gray-900 border border-[#828282] p-6 rounded-lg">
        <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Assess Necessity & Proportionality</h3>
        <div className="space-y-6">
          {renderSelect("necessityProportionality", "processingNecessary", {
            value: formData.necessityProportionality.processingNecessary,
            onChange: (e) => handleInputChange("necessityProportionality", "processingNecessary", e.target.value),
          ...
          {renderSelect("necessityProportionality", "legalBasis", {
            ...
            onChange: (e) => handleInputChange("necessityProportionality", "legalBasis", e.target.value),
            label: "What is the legal basis for processing (under Article 6 or 9 of GDPR)?",
            children: (
              <>
          ...
          {renderTextarea("necessityProportionality", "dataMinimization", {
            ...
            onChange: (e) => handleInputChange("necessityProportionality", "dataMinimization", e.target.value),
          ...
          {renderTextarea("necessityProportionality", "retentionPeriods", {
            ...
            onChange: (e) => handleInputChange("necessityProportionality", "retentionPeriods", e.target.value),
          ...
          {renderTextarea("necessityProportionality", "accessControls", {
            ...
            onChange: (e) => handleInputChange("necessityProportionality", "accessControls", e.target.value),
          ...
          {renderSelect("necessityProportionality", "individualsInformed", {
            ...
            onChange: (e) => handleInputChange("necessityProportionality", "individualsInformed", e.target.value),
          ...
          {renderFileUpload("necessityProportionality", "necessityDocuments", "Please upload any supporting documents")}
        </div>
      </div>
    </div>
  );
  ...
  const renderStage3 = () => (
    <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
      <div className="bg-gray-50 dark:bg-gray-900 border border-[#828282] p-6 rounded-lg">
        <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Identify Risks to Individuals</h3>
        <div className="space-y-6">
          {renderTextarea("riskIdentification", "potentialRisks", {
            value: formData.riskIdentification.potentialRisks,
            onChange: (e) => handleInputChange("riskIdentification", "potentialRisks", e.target.value),
          ...
          <div className="grid grid-cols-2 gap-4">
            {renderSelect("riskIdentification", "riskLikelihood", {
              ...
              onChange: (e) => handleInputChange("riskIdentification", "riskLikelihood", e.target.value),
            ...
            {renderSelect("riskIdentification", "riskImpact", {
              ...
              onChange: (e) => handleInputChange("riskIdentification", "riskImpact", e.target.value),
          ...
          {renderTextarea("riskIdentification", "vulnerableGroups", {
            ...
            onChange: (e) => handleInputChange("riskIdentification", "vulnerableGroups", e.target.value),
            placeholder: "e.g., children, elderly, disabled individuals, employees...",
            label: "Are any vulnerable groups affected?",
            rows: 3,
          })}
          
          {renderFileUpload("riskIdentification", "riskDocuments", "Please upload any risk assessment documents")}
        </div>
      </div>
    </div>
  );
  ...
  const renderStage4 = () => (
    <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
      <div className="bg-gray-50 dark:bg-gray-900 border border-[#828282] p-6 rounded-lg">
        <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Evaluate and Mitigate Risks</h3>
        <div className="space-y-6">
          {renderTextarea("riskMitigation", "existingControls", {
            value: formData.riskMitigation.existingControls,
            onChange: (e) => handleInputChange("riskMitigation", "existingControls", e.target.value),
            placeholder: "Describe existing controls and safeguards...",
            label: "What existing controls are in place to mitigate the risks?",
            rows: 3,
          })}
          
          {renderTextarea("riskMitigation", "additionalMeasures", {
            value: formData.riskMitigation.additionalMeasures,
            onChange: (e) => handleInputChange("riskMitigation", "additionalMeasures", e.target.value),
          ...
          {renderTextarea("riskMitigation", "responsiblePersons", {
            ...
            onChange: (e) => handleInputChange("riskMitigation", "responsiblePersons", e.target.value),
            placeholder: "List responsible persons/teams for each mitigation...",
          ...
          {renderTextarea("riskMitigation", "residualRisk", {
            ...
            onChange: (e) => handleInputChange("riskMitigation", "residualRisk", e.target.value),
            placeholder: "Describe the residual risk level after mitigation...",
            label: "After mitigation, what is the residual risk level?",
            rows: 3,
          })}
          
          {renderFileUpload("riskMitigation", "mitigationDocuments", "Please upload any mitigation plan documents")}
        </div>
      </div>
    </div>
  );
  ...
  const renderStage5 = () => (
    <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
      <div className="bg-gray-50 dark:bg-gray-900 border border-[#828282] p-6 rounded-lg">
        <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Sign-off, Review & Consultation</h3>
        <div className="space-y-6">
          {renderSelect("signoffReview", "dpoConsulted", {
            value: formData.signoffReview.dpoConsulted,
            onChange: (e) => handleInputChange("signoffReview", "dpoConsulted", e.target.value),
          ...
          {renderTextarea("signoffReview", "stakeholdersConsulted", {
            ...
            onChange: (e) => handleInputChange("signoffReview", "stakeholdersConsulted", e.target.value),
            placeholder: "List internal and external stakeholders consulted...",
          ...
          {renderTextarea("signoffReview", "feedbackObjections", {
            ...
            onChange: (e) => handleInputChange("signoffReview", "feedbackObjections", e.target.value),
            placeholder: "Describe any feedback, concerns, or objections raised...",
            label: "What was the feedback or objections, if any?",
            rows: 3,
          })}
          
          {renderCheckboxGroup("signoffReview", "finalOutcome", "Final assessment outcome:", finalOutcomeOptions, true)}
          
          <div className="grid grid-cols-2 gap-4">
            {renderInput("signoffReview", "nextReviewDate", {
              type: "date",
              value: formData.signoffReview.nextReviewDate,
              onChange: (e) => handleInputChange("signoffReview", "nextReviewDate", e.target.value),
            ...
            {renderInput("signoffReview", "accountablePerson", {
              ...
              onChange: (e) => handleInputChange("signoffReview", "accountablePerson", e.target.value),
              placeholder: "Enter name of accountable person/team...",
              label: "Record accountable person/team",
            })}
          </div>
          
          {renderFileUpload("signoffReview", "consultationDocuments", "Please upload consultation records and review documents")}
        </div>
      </div>
    </div>
  );
